...
def get_transcript_from_url(video_url: str) -> str:
    ...
    # Updated options: added 'writeautomaticsub' and 'en.*' regex
    ydl_opts = {
        'writesubtitles': True, 
        'writeautomaticsub': True,      # Fallback to auto-captions
        'skip_download': True, 
        'subtitleslangs': ['en.*'],     # Matches 'en', 'en-US', 'en-IN', etc.
    ...
    with YoutubeDL(ydl_opts) as ydl:
        ...
        # Look for ANY file starting with the video_id and ending in .vtt
        # This handles cases like 'xyz.en.vtt' or 'xyz.en-US.vtt'
        ...
        vtt_path = files[0] # Use the first matching file
